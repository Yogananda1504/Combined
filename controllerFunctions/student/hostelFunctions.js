 ...
 */
import Complaints from "../../models/HostelComplaints.js";
import appError from "../../utils/student/appError.js";
import validator from "validator";
import { automateEmail } from "../../utils/student/email_automator.js";
...
const registerComplaintHostel = async (req, res, next) => {
	try {
		...
		console.log("Error in Submitting the Hostel Complaint :  ", error.message);
		next(error);
	}
};
